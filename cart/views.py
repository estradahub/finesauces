...
def cart_detail(request):
    ...
    for product in products:
        ...
        cart_item['total price'] = (Decimal(cart_item['price']) * cart_item['quantity'])
    ...
    return render(request, 'detail.html', {'cart': temp_cart.values(), 'cart_total_price': cart_total_price})